    ...
    list(
      ...
      buttons = list(
        ...
        list(method = "restyle",
             ...
             label = "HIV Density"),
        list(method = "restyle",
             args = list("z", list(death_causes$complication_of_pregnancy_birth), "text", list(death_causes$complication_of_pregnancy_birth), "color", list(death_causes$complication_of_pregnancy_birth)), 
